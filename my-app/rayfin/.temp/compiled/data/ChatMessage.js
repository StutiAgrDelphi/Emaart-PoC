...
let ChatMessage = (() => {
    ...
    var ChatMessage = class {
        ...
        static {
            ...
            _id_decorators = [uuid()];
            _session_id_decorators = [text()];
            _role_decorators = [text()];
            _content_decorators = [text()];
            _timestamp_decorators = [date()];
        ...
        session_id = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _session_id_initializers, void 0));
        role = (__runInitializers(this, _session_id_extraInitializers), __runInitializers(this, _role_initializers, void 0));
        content = (__runInitializers(this, _role_extraInitializers), __runInitializers(this, _content_initializers, void 0));
        timestamp = (__runInitializers(this, _content_extraInitializers), __runInitializers(this, _timestamp_initializers, void 0));
        constructor() {
